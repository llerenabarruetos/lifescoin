<?php
    function GetPosts($newTopic) /*Will user the variable $newTopic within this user's instance to get Current Topic */
    {
        ...
        $returningCode = "<div class='postArea' id='tabs'>";
        $tabIndex = 1;
