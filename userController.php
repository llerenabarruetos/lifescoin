<?php
		//PHP file with the functions for each request made to this file via AJAX-sent variable $_REQUEST
		//	These requests are to modify the right panel of the main feed ("The wild card" panel)
        ...
        function GetTopicBar()
        {
            ...
            {
                if ($index < 7) //Max number of tabs in bar is 7
                {
        ...
        {
            //Post form is always this HTML code
        ...
        {
			//Shows the form to join or create a new topic/group
            $plusForm = 
        ...
        function ShowCommentView($postId)
        {
            ...
            $poster = $row['user']; //Make sure all of these match the DB 
            $text = $row['text'];
			...
			//Write the HTML for the comment view and fill it with the post and poster's information
